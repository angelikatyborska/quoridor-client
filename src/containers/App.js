  ...
  render() {
    return (
      <div>
        ...
        <input placeholder="nickname" onChange={(event) => {this.setState({nickname: event.target.value})}}/>
        <input placeholder="room id" onChange={(event) => {this.setState({roomId: event.target.value})}}/>
        <input placeholder="capacity" onChange={(event) => {this.setState({capacity: event.target.value})}}/>
        <input placeholder="move" onChange={(event) => {this.setState({move: event.target.value})}}/>
        <button onClick={() => {
        this.props.send(
          {
